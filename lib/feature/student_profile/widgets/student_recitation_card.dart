...
import 'package:masjid/feature/circles/widgets/circle_recitation/recitation_rating_badge.dart';
...
class StudentRecitationCard extends StatelessWidget {
  final StudentRecitationDetailModel recitation;

  const StudentRecitationCard({super.key, required this.recitation});
